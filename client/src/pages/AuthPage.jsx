        ...
        >
          ...
          {isSignUp && (
            <div className="input_container">
              ...
              <div className="fieldShell">
                ...
                <input placeholder="Jane Doe" autoComplete="name" name="name" type="text" className="input_field" id="name_field" />
              </div>
            </div>
          )}
          ...
          <div className="input_container">
            ...
            <div className="fieldShell">
              ...
              <input placeholder="name@mail.com" autoComplete="email" name="email" type="email" className="input_field" id="email_field" />
            </div>
          </div>
          ...
          <div className="input_container">
            ...
            <div className="fieldShell">
              ...
              <input placeholder="Password" autoComplete={isSignUp ? 'new-password' : 'current-password'} name="password" type="password" className="input_field" id="password_field" />
            </div>
          </div>
          ...
          {isSignUp && (
            <div className="input_container">
              ...
              <div className="fieldShell">
                ...
                <input placeholder="Confirm password" autoComplete="new-password" name="confirmPassword" type="password" className="input_field" id="confirm_password_field" />
              </div>
            </div>
          )}
