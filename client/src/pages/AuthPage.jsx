        ...
        >
          ...
          {isSignUp && (
            <div className="input_container">
              ...
              <div className="fieldShell">
                ...
                <input placeholder="Username" autoComple  te="name" name="name" type="text" className="input_field" id="name_field" onChange={(e) => setUsername(e.target.value)}/>
              </div>
            </div>
          )}
          ...
          <div className="input_container">
            ...
            <div className="fieldShell">
              ...
              <input placeholder="name@mail.com" autoComplete="email" name="email" type="text" className="input_field" id="email_field" onChange={(e) => {
          ...
          <div className="input_container">
            ...
            <div className="fieldShell">
              ...
              <input placeholder="Password" autoComplete={isSignUp ? 'new-password' : 'current-password'} name="password" type="password" className="input_field" id="password_field" onChange={(e) => setPassword(e.target.value)}/>
            </div>
          </div>
          ...
          {isSignUp && (
            <div className="input_container">
              ...
              <div className="fieldShell">
                ...
                <input placeholder="Confirm password" autoComplete="new-password" name="confirmPassword" type="password" className="input_field" id="confirm_password_field" onChange={(e) => setConfirmPassword(e.target.value)}/>
              </div>
            </div>
          )}

          <button title={isSignUp ? 'Create Account' : 'Sign In'} type="submit" className="sign-in_btn" onClick={isSignUp ? handleSignUp : handleLogin}>
